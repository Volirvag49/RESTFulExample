...
{
    public class GenericServiceRepository<T> : IServiceRepository<T> where T : BaseServiceEntity
    {
        protected ApplicationDBContext dbContext;
        protected DbSet<T> dbSet;

        public GenericServiceRepository(ApplicationDBContext context)
        {
            dbContext = context;
            dbSet = context.Set<T>();
        }
        ...
        public async Task<T> GetByIdAsynс(string id)
        {
