...
namespace RESTFulExample.API.Controllers
{
    ...
    public class TrainsToCartController : Controller
    {
        private readonly ICartService _cartService;
        private readonly IMapper _mapper;

        public TrainsToCartController(ICartService cartService, IMapper mapper)
        {
        ...
        public async Task<IActionResult> Post([FromBody] ServiceVM serviceVM)
        {
            ...
            try
            {
                ...
                await _cartService.AddTrainAsync(serviceDTO);
